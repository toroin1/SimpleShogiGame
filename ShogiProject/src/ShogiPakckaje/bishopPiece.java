...
public class bishopPiece extends Piece {
	...
	private  int[][] internelRules =  {{1,1},{-1,1},{-1,-1},{1,-1}};
	private int[][] promotionInternelRules = {{1,0},{-1,0},{0,1},{0,-1}};
	...
	public void promotionImage() {
		if(!isPromoted) {
			try {
				ally = ImageIO.read(new File("Shogi_kakugyo.png"));
				enemy = ImageIO.read(new File("Shogi_kakugyo_enemy.png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
		}else {
			try {
				ally = ImageIO.read(new File("Shogi_ryuma.png"));
				enemy = ImageIO.read(new File("Shogi_ryuma_enemy.png"));
			} catch (IOException e) {
